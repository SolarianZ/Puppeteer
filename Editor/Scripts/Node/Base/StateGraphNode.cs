...
{
    public abstract class StateGraphNode : GraphNode
    {
        ...
        protected StateGraphNode(AnimationGraphAsset graphAsset, GraphData.GraphData graphData) : base(graphAsset)
        {
            GraphData = graphData;
        ...
        public virtual StateTransitionEdge AddTransition(StateGraphNode destNode, out bool dataDirty)
        {
        ...
        public StateTransitionEdge RemoveTransition(StateGraphNode destNode)
        {
        ...
        public StateTransitionEdge ViewOnlyConnect(StateGraphNode destNode)
        {
        ...
        public StateTransitionEdge ViewOnlyDisconnect(StateGraphNode destNode)
        {
